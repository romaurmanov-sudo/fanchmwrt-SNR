...
# 1. Create the U-Boot patch
cat << 'EOF' > package/boot/uboot-mediatek/patches/461-add-snr-cpe-ax2.patch
--- /dev/null
+++ b/configs/mt7981_snr_cpe_ax2_defconfig
@@ -0,0 +1,108 @@
+CONFIG_ARM=y
...
+CONFIG_DEFAULT_DEVICE_TREE="mt7981-snr-cpe-ax2"
...
+CONFIG_DEFAULT_FDT_FILE="mediatek/mt7981-snr-cpe-ax2.dtb"
+CONFIG_LOGLEVEL=7
+CONFIG_PRE_CONSOLE_BUFFER=y
+CONFIG_LOG=y
+CONFIG_BOARD_LATE_INIT=y
+CONFIG_HUSH_PARSER=y
+CONFIG_SYS_PROMPT="SNR-CPE-AX2> "
+CONFIG_CMD_CPU=y
...
+CONFIG_DEFAULT_ENV_FILE="snr_cpe_ax2_env"
...
--- /dev/null
+++ b/arch/arm/dts/mt7981-snr-cpe-ax2.dts
@@ -0,0 +1,187 @@
...
# 2. Append the board definition to the Makefile
cat << 'EOF' >> package/boot/uboot-mediatek/Makefile

define U-Boot/snr_cpe_ax2
  NAME:=SNR CPE AX2
  BUILD_SUBTARGET:=filogic
  BUILD_DEVICES:=snr_snr-cpe-ax2
  UBOOT_CONFIG:=mt7981_snr_cpe_ax2
...
echo "Done. Patch created and Makefile updated."
